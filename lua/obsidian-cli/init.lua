...
local function set_global_keymaps()
  ...
  map("<leader>oT", ":ObsidianTask ", "Obsidian: task capture")
  map("<leader>oa", ":ObsidianAppend ", "Obsidian: append to today")
  map("<leader>on", ":ObsidianNew ", "Obsidian: new note")
  map("<leader>oN", ":ObsidianNewFrom ", "Obsidian: new from template")
  map("<leader>of", "<cmd>ObsidianFind<cr>", "Obsidian: find note")
  map("<leader>or", "<cmd>ObsidianRecent<cr>", "Obsidian: recent notes")
  map("<leader>os", ":ObsidianSearch ", "Obsidian: search")
  map("<leader>ox", "<cmd>ObsidianTasksToday<cr>", "Obsidian: today's tasks")
  map("<leader>ou", "<cmd>ObsidianUnresolved<cr>", "Obsidian: unresolved links")
end
